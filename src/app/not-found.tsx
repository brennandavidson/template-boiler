      ...
      <PageWrapper>
        <div className="min-h-screen flex items-center justify-center px-4 py-24">
          <div className="max-w-2xl w-full text-center">
            {/* 404 Number */}
            <div className="mb-8">
              <h1 className="text-8xl sm:text-9xl font-bold text-background-blue">
                404
              </h1>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold text-background-blue mb-4">
                Page Not Found
              </h2>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/"
                  className="inline-flex items-center justify-center px-6 py-3 bg-primary hover-dark text-white font-medium rounded-lg transition-colors"
                >
