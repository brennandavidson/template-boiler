  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Darker background blue - less vibrant for hero sections and backgrounds
        'background-blue': {
          DEFAULT: 'var(--color-background-blue)',
          light: 'var(--color-background-blue-light)',
          dark: 'var(--color-background-blue-dark)',
        },
